...
%% Loop through files
    ...
    assert(~isempty(td_preproc),sprintf('Incomplete dataset for file %d\n',filenum))
    assert(~isempty(td_preproc(1).M1_unit_guide),sprintf('Skipping file %d because no spike data...\n',filenum))
